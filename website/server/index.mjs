...
function readRelease() {
  if (!existsSync(releaseFile)) return { version: '1.5.1', summary: 'Desktop, self-hosted and managed cloud operations in one calm workspace.', publishedAt: null, downloads: [] }
